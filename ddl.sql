...
create index m2m_group_id_index
    on public.auth_group_permissions (group_id);

create index m2m_permission_id_index
...
create index m2m_user_id_index
...
(
    ...
    permission_id   integer not null
                    ...
                    references public.auth_permission
                    deferrable initially deferred,
    constraint user_user_permissions_user_id_permission_id_unique
